...
Usage: python standalone_cgf1.py --pred_file <path_to_prediction_file> --gt_files <path_to_gt_file1> <path_to_gt_file2> ... [--iou_type segm|bbox]
"""
...
def main():
    ...
    evaluator = CGF1Evaluator(
        gt_path=args.gt_files, verbose=True, iou_type=args.iou_type
    )
